...
namespace DXApplication1
{
    public partial class MainForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        */
        ...
        {
            this.timer_tileBar_statusMonitoringAutoClose.Enabled = true;
        }

        private void tileBar_dataAnalysis_ItemClick(object sender, TileItemEventArgs e)
        {
            this.timer_tileBar_dataAnalysisAutoClose.Enabled = true;
        }

        private void tileBar_twinDetection_ItemClick(object sender, TileItemEventArgs e)
        {
            this.timer_tileBar_twinDetectionAutoClose.Enabled = true;
        }

        private void timer_tileBar_statusMonitoringAutoClose_Tick(object sender, EventArgs e)
        {
            this.tileBar_mainMenu.HideDropDownWindow(false);
            this.timer_tileBar_statusMonitoringAutoClose.Enabled = false;
        }

        private void timer_tileBar_dataAnalysisAutoClose_Tick(object sender, EventArgs e)
        {
            this.tileBar_mainMenu.HideDropDownWindow(false);
            this.timer_tileBar_dataAnalysisAutoClose.Enabled = false;
        }

        private void timer_tileBar_twinDetectionAutoClose_Tick(object sender, EventArgs e)
        {
            this.tileBar_mainMenu.HideDropDownWindow(false);
            this.timer_tileBar_twinDetectionAutoClose.Enabled = false;
        }
