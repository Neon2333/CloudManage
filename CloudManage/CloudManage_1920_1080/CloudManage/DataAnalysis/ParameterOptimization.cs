...
namespace CloudManage.DataAnalysis
{
    public partial class ParameterOptimization : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        {
            //string url = "http://192.168.8.100:8080/analysis_toolparam/?packer_id=" + this.sideTileBarControlWithSub_ParameterOptimization.tagSelectedItem.ToString() + "&device_id=" + this.sideTileBarControlWithSub_ParameterOptimization.tagSelectedItemSub.ToString() + "&shift=all&start_time=" + timeEdit_startTime.Time.ToLocalTime() + "&end_time=" + timeEdit_endTime.Time.ToLocalTime();
