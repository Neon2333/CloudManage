...
namespace CloudManage
{
    public partial class MainForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        public static event ModelTrainingDialogShowOrClose modelTrainingDialogHide;
        ...
        private void initMain()
        {
            ...
            Thread threadRunTrainDialog = new Thread(runTrainDialog);
            threadRunTrainDialog.IsBackground = true;
            threadRunTrainDialog.Name = "runDialogThread";
            threadRunTrainDialog.Start();
        }

        private void runTrainDialog()
        {
